function Home() {
    return ( 
       <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <h2 className="mt-2 text-xl text-grat-600">Rama y Raices</h2>
        <p className="mt-6 text-lg text-gray-700 max-w-2xl mx-auto">Contemporary choral music for ensembles of all sizes.</p>
        </section>
        {/* Hero Section */}
